...
set rc [catch {
  ...
  add_files -quiet /home/ecestudent/ECE2700/Lab5/counter/counter.runs/synth_1/counter.dcp
...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file counter_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file counter_timing_summary_routed.rpt -pb counter_timing_summary_routed.pb -rpx counter_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file counter_bus_skew_routed.rpt -pb counter_bus_skew_routed.pb -rpx counter_bus_skew_routed.rpx"
